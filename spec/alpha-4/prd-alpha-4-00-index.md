...
| 11 | [Library API stability & §17.9 acceptance](./prd-alpha-4-11-library-and-acceptance.md)   | `@lando/core/testing` stable on `next`, full §16.2 contract suite, stable App handles/runtime object, plugin SDK `^4.0.0`, §17.9 acceptance on linux-x64 | US-272..US-279, US-289..US-292 | PRD-01 through PRD-10    |
