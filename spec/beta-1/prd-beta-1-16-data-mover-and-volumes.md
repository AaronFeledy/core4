...
- Cross-host/remote transfer transport; a `RemoteSource` plugin (§10.12, PRD-17) owns remote I/O via `HttpClient` and uses `DataMover` only for the local extract/land half.
