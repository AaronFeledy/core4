...
| Global `EventService` bus is `PubSub.unbounded`; a stalled dynamic consumer grows the bus without bound | US-456 review deferred (cross-subsystem hardening) | US-465 |
