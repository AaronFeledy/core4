...
| Published Linux runtime asset is checksum-valid but remote-only and rejects managed-service `--root` / `--runroot` | PRD-10 US-410/US-411 and progress US-411 verify/review entries | US-430 (and reopens US-410, US-411) |
