# PRD: ALPHA1-01 — Runtime providers

## Introduction

This PRD covers Phase 2 Alpha 1 work for **Runtime providers**. It translates the Alpha 1 section of [`spec/ROADMAP.md`](../ROADMAP.md) into implementation-sized stories while preserving the MVP rule that the detailed spec parts remain source of truth.
...
**Acceptance Criteria:**
- [ ] Schema test asserts every Alpha 1 capability field has a provider-lando value for Linux and macOS
- [ ] Planner rejects unsupported Alpha 1 features with a tagged error before apply
...
**Description:** As a user with Docker Desktop or system Docker, I can use provider-docker as an Alpha 1 alternative path.
...
**Acceptance Criteria:**
- [ ] `@lando/sdk/test` exposes the provider contract suite drafted in MVP with Alpha 1 lifecycle coverage
