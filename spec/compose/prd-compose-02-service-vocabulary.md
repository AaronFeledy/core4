...
- Conflicts resolve deterministically: the more specific Lando key wins, and `lando app config` shows the resolved value.
...
- [ ] `lando app config view --format yaml` renders the post-normalization resolved values.
