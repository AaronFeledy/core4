...
│   │   ├── render.ts               # Template renderer (extends §7.3.1 expressions)
...
|---|---|---|
| `ConfigService` | Global config + env overrides | `ConfigServiceLive` |
| `LandofileService` | Discovery, parse, merge, validate | `LandofileServiceLive` |
