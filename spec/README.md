...
| `Downloader` verified downloads (proxy/CA-aware, checksum-verified, atomic, redacted) | 04 + 11 | §4.2 + §10.3.2 |
| `pre-download` / `download-progress` / `post-download` lifecycle events | 03 | §3.5 + §11.2 |
| Downloader contract suite (mandatory) | 13 | §13.1 |
