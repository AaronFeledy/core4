            ...
            Effect.gen(function* () {
              ...
              const cleanupExit = yield* Effect.exit(
                Effect.gen(function* () {
                  ...
                  if (sessionLease.rollbackTargets && preparedRollback !== undefined) yield* preparedRollback;
                  yield* Ref.set(leaseCleanupDone, true);
                  if (sessionLease.rollbackTargets && pendingStart !== undefined) yield* pendingStart.clear;
                }),
              );
