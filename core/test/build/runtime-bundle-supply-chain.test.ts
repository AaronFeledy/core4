...
describe("runtime-bundle workflow supply chain", () => {
  ...
  test("installs Ubuntu build prerequisites from one fixed snapshot", async () => {
    const workflow = await renderWorkflow();
    const snapshotConfig = workflow.indexOf("UBUNTU_SNAPSHOT=20260801T000000Z");
  ...
  Version table:
 *** 1.0 500
        500 https://snapshot.ubuntu.com/ubuntu/20260801T000000Z noble/main amd64 Packages
POLICY
seq 1 100000`;
 ...
 *** 2.0 500
     ...
     1.0 100
        100 https://snapshot.ubuntu.com/ubuntu/20260801T000000Z noble/main amd64 Packages
POLICY`;
