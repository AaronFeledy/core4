...
describe("ci workflow codegen", () => {
  ...
  test(
    ...
    async () => {
      ...
      for (const generatedWorkflow of [workflow, nightlyWorkflow, releaseWorkflow]) {
      ...
      for (const generator of [ciWorkflowGenerator, nightlyWorkflowGenerator, releaseWorkflowGenerator]) {
