...
describe("ci workflow codegen", () => {
  ...
  test(
    ...
    async () => {
      ...
      expect(workflow).toContain("- name: Package DAG lint");
      expect(workflow).toContain("run: bun run check:package-dag");
      ...
      expect(workflow).not.toContain("Core layering boundary lint");
      expect(workflow).not.toContain("check:core-layering-boundary");
