...
describe("ci workflow codegen", () => {
  ...
  test(
    ...
    async () => {
      ...
      expect(workflow).toContain("- name: Architecture boundary kernel");
      expect(workflow).toContain("run: bun run check:architecture");
      ...
      expect(workflow).toContain("- name: Libpod API prefix lint");
      expect(workflow).toContain("run: bun run check:libpod-prefix");
      expect(workflow).toContain("- name: Machine output boundary lint");
      expect(workflow).toContain("run: bun run check:machine-output");
