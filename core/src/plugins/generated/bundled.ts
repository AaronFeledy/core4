...
import { plugin as plugin8 } from "@lando/proxy-traefik";
import { plugin as plugin5 } from "@lando/renderer-lando";
import { plugin as plugin3 } from "@lando/service-lando";
import { plugin as plugin9 } from "@lando/template-handlebars";
import { plugin as plugin10 } from "@lando/template-mustache";
