...
import { plugin as plugin0 } from "@lando/ca-mkcert";
import { plugin as plugin8 } from "@lando/file-sync-mutagen";
import { plugin as plugin5 } from "@lando/logger-pretty";
import { plugin as plugin7 } from "@lando/notify-lando";
import { plugin as plugin2 } from "@lando/provider-docker";
import { plugin as plugin1 } from "@lando/provider-lando";
import { plugin as plugin3 } from "@lando/provider-podman";
import { plugin as plugin9 } from "@lando/proxy-traefik";
import { plugin as plugin6 } from "@lando/renderer-lando";
import { plugin as plugin4 } from "@lando/service-lando";
