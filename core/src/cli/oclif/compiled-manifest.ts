...
export const COMPILED_OCLIF_MANIFEST = {
  commands: {
    ...
    "app:open": {
      aliases: ["open"],
      args: {},
      description: "Open a resolved app URL in the host browser.",
      flags: {
        format: {
          description: "Output format.",
          name: "format",
        ...
        service: {
          char: "s",
          description: "Scope resolution to a single service's routes.",
          name: "service",
          hasDynamicHelp: false,
          multiple: false,
          type: "option",
        ...
        route: {
          description: "Select an exact route hostname to open.",
          name: "route",
          hasDynamicHelp: false,
          multiple: false,
          type: "option",
        ...
        all: {
          description: "Open every resolved route.",
          name: "all",
          allowNo: false,
          type: "boolean",
        },
        print: {
          description: "Print the resolved URL(s) instead of opening a browser.",
          name: "print",
          allowNo: false,
          type: "boolean",
        },
      ...
      bootstrap: "app",
      aliasPermutations: ["open"],
      permutations: ["app:open", "open:app"],
    },
    "app:pull": {
      aliases: ["pull"],
      args: {
    ...
    "apps:scratch:run": {
      ...
      args: {},
      description: "Run a one-off command in a disposable scratch app.",
      flags: {
        format: {
          description: "Output format.",
          name: "format",
        ...
        service: {
          description: "Service to run the command in (default: the primary service).",
          name: "service",
          hasDynamicHelp: false,
          multiple: false,
          type: "option",
      ...
      bootstrap: "scratch",
      aliasPermutations: ["scratch:run", "run:scratch", "run"],
      permutations: [
        "apps:scratch:run",
        "scratch:apps:run",
        "scratch:run:apps",
    ...
    "meta:mcp": {
      aliases: ["mcp"],
      args: {},
      description: "Serve the Model Context Protocol over stdio, or --list the effective tool catalog.",
      flags: {
        format: {
          description: "Output format.",
          name: "format",
        ...
        deny: {
          description:
            "Deny a command id from the effective MCP tool catalog; repeat to deny multiple commands.",
          name: "deny",
          hasDynamicHelp: false,
          multiple: true,
          type: "option",
      ...
      bootstrap: "plugins",
      aliasPermutations: ["mcp"],
      permutations: ["meta:mcp", "mcp:meta"],
    },
    "meta:plugin:add": {
      aliases: ["plugin:add"],
      args: {
    ...
    "meta:recipes:describe": {
      ...
      args: {
        ref: {
          description: "Recipe ref: a bundled recipe id or a local path.",
          name: "ref",
          required: true,
        },
      },
      description: "Print a recipe's prompts and metadata without running it.",
      flags: {
        format: {
          description: "Output format.",
          name: "format",
      ...
      permutations: [
        "meta:recipes:describe",
        "recipes:meta:describe",
        "recipes:describe:meta",
        "meta:describe:recipes",
        "describe:meta:recipes",
        "describe:recipes:meta",
      ],
    },
    "meta:recipes:list": {
      aliases: ["recipes"],
    ...
    "meta:recipes:validate": {
      ...
      description: "Validate a recipe.yml against the published schema.",
      flags: {
        format: {
          description: "Output format.",
          name: "format",
      ...
      permutations: [
        "meta:recipes:validate",
        "recipes:meta:validate",
        "recipes:validate:meta",
        "meta:validate:recipes",
        "validate:meta:recipes",
        "validate:recipes:meta",
      ],
    },
    "meta:setup": {
      aliases: ["setup"],
