...
export const COMPILED_OCLIF_MANIFEST = {
  commands: {
    ...
    "meta:plugin:trust": {
      ...
      description: "Trust an installed plugin (persistent trust deferred to Beta).",
      flags: {},
      hasDynamicHelp: false,
      hidden: false,
      hiddenAliases: [],
    ...
    "meta:plugin:trust-authoring-root": {
      ...
      description: "Authorize an absolute path as a plugin authoring root (Phase 4 RC deliverable).",
      flags: {},
      hasDynamicHelp: false,
      hidden: false,
      hiddenAliases: [],
