...
export const PODMAN_COMPOSE_KNOB_REGISTRY = {
  ...
  tmpfs: hostConfigKnob("Tmpfs", ({ tmpfs }) => tmpfsMounts(tmpfs)),
  shm_size: hostConfigKnob("ShmSize", ({ shm_size }) => shm_size),
  ...
  stop_grace_period: topLevelKnob("StopTimeout", ({ stop_grace_period }) => stop_grace_period),
