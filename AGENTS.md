...
- Standard gate after code changes is `bun run typecheck` plus `bun test`; root `tsc -b` typechecks every test tree through the referenced aggregate test project.
