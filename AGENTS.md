...
- The Windows Lando-owned Podman machine exposes its API at `\\.\pipe\podman-lando`; do not probe the Linux managed-service socket under `runtime/run/podman.sock` on win32.
