...
| BETA1-PRD-15 | US-459 | Desktop notification policy and `notify:` configuration | `docs/guides/cli/terminal-ui-polish.mdx` | Shipped |
...
| ST-PRD-02 | US-490, US-491, US-492, US-500 | `certs:` authoring, mkcert Live, active CA selection, and `lando.certs` leaf issuance | `docs/guides/subsystems/certificates-mkcert.mdx` | Shipped |
...
| ST-PRD-02 | US-494, US-496 | language-runtime CA env table and guide-pack closure | `docs/guides/config/corporate-network-trust.mdx` | Shipped |
...
| ST-PRD-02 | US-497 | Traefik edge TLS certificates from the active CA | `docs/guides/subsystems/proxy-traefik.mdx` | Shipped |
