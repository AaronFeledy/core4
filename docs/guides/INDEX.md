...
| BETA1-PRD-15 | US-458 | Foreground desktop notifications (future ownership; not yet landed in this guide's body) | `docs/guides/cli/terminal-ui-polish.mdx` | Planned |
