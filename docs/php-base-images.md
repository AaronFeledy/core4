...
PHP 8.6 is in that generated set. Official Hub currently publishes 8.6 as RC bookworm tags, so `images/php/8.6/Dockerfile` starts from `php:8.6-rc-apache-bookworm`.
