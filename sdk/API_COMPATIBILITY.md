...
- `GlobalConfig.events.deliveryQueueCapacity` is an additive optional positive-integer host override for core's bounded, non-blocking event delivery queue; the runtime default remains 64.
