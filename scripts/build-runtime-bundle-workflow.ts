...
// Podman 6 drops Intel Mac support, so darwin-x64 is not published. The shared
// RUNTIME_BUNDLE_TARGETS constant still carries darwin-x64 pending its separate
// removal; these are the four runtime host keys that ship as release assets.
