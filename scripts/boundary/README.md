...
The renderer rule is classified `thin` after removing two obsolete source carve-outs. Paths, probe, redaction, and state-store already contain only residual enforcement. The sole `delete` verdict has been executed.
