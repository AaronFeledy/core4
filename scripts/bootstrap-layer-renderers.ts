export const renderMinimal = (): string =>
  [
    ...
    "    noneRuntimeLive,",
    "    LoggerLive({ mode: inputs.loggerMode, logLevel: inputs.logLevel, structured: inputs.structured, ...(inputs.writeDiagnosticLine === undefined ? {} : { writeLine: inputs.writeDiagnosticLine }) }),",
