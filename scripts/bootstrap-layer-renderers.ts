export const renderMinimal = (): string =>
  [
    ...
    'import { CacheServiceWithProcessRunnerLive } from "@lando/engine/cache/service";',
    ...
    'import { ManagedFileServiceWithProcessRunnerLive } from "@lando/managed-file/service";',
    ...
    'import { StateStoreWithProcessRunnerLive } from "@lando/state-store/service";',
    ...
    "    CacheServiceWithProcessRunnerLive.pipe(Layer.provide(ProcessRunnerLive)),",
    "    FileSystemLive,",
    "    ProcessRunnerLive,",
    "    PrivilegeServiceLive,",
    "    SecretStoreLive,",
    "    StateStoreWithProcessRunnerLive.pipe(Layer.provide(ProcessRunnerLive)),",
    "    ManagedFileTransactionGuardLive.pipe(Layer.provide(ProcessRunnerLive)),",
    "    redactionLive,",
    "    Layer.suspend(() => ManagedFileServiceWithProcessRunnerLive).pipe(",
    "      Layer.provide(Layer.mergeAll(eventServiceLive, redactionLive, ProcessRunnerLive)),",
    "    ),",
...
export const renderCommands = (): string =>
  [
    ...
    "  const subscriberRuntimeLive = makeSubscriberRuntimeWithProcessRunnerLive(bundledPluginModules(), BUILT_IN_COMMAND_IDS).pipe(Layer.provide(commandsBase));",
...
export const renderProvider = (): string =>
  [
    ...
    'import { makeSubscriberRuntimeWithProcessRunnerLive } from "@lando/engine/lifecycle/subscribers";',
    'import { makeRuntimeProviderRegistryWithProcessRunner } from "@lando/engine/providers/registry";',
    ...
    "  const providerRegistryLive = makeRuntimeProviderRegistryWithProcessRunner(bundledPluginModules()).pipe(",
    ...
    "  const subscriberRuntimeLive = makeSubscriberRuntimeWithProcessRunnerLive(bundledPluginModules(), BUILT_IN_COMMAND_IDS).pipe(Layer.provide(providerBase));",
