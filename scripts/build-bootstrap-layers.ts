...
const renderPlugins = (): string =>
  [
    ...
    'import { DeprecationPluginRegistryLive } from "@lando/engine/deprecation/plugin-registry";',
    ...
    "    cwd: inputs.cwd,",
    "  }, bundledPluginModules()).pipe(Layer.provide(minimalRuntimeLive));",
    "  const pluginRegistryLive = makePluginRegistryLive(inputs.pluginDiscovery, bundledPluginModules()).pipe(",
    ...
    "    Layer.provide(Layer.merge(minimalRuntimeLive, contributionGraphLive)),",
    "  );",
    "  return Layer.mergeAll(minimalRuntimeLive, contributionGraphLive, pluginRegistryLive, deprecationRegistryLive, configTranslatorRegistryLive, BuiltInCommandCatalogLive).pipe(",
...
const renderTooling = (): string =>
  [
    ...
    'import { EventService } from "@lando/sdk/services";',
    'import { bundledPluginModules } from "@lando/engine/composition";',
    'import { makeSubscriberRuntimeWithProcessRunnerLive } from "@lando/engine/lifecycle/subscribers";',
    'import type { BootstrapLayerInputs } from "@lando/engine/runtime/bootstrap-layer-support";',
    ...
    "  const subscriberRuntimeLive = makeSubscriberRuntimeWithProcessRunnerLive(bundledPluginModules(), BUILT_IN_COMMAND_IDS).pipe(Layer.provide(toolingBase));",
...
const renderScratch = (): string =>
  [
    ...
    "    routerRegistryLive,",
    "    routerServiceLive,",
    "    ScratchRegistryWithProcessRunnerLive.pipe(Layer.provide(providerBase)),",
...
const renderApp = (): string =>
  [
    ...
    'import { makeSubscriberRuntimeWithProcessRunnerLive } from "@lando/engine/lifecycle/subscribers";',
    'import { GlobalAppRuntimeLive } from "@lando/engine/global-app/runtime";',
    'import { makeBundledFileSyncEngineLive } from "@lando/engine/plugins/file-sync-from-modules";',
    'import { BuildOrchestratorLive } from "@lando/engine/services/build-orchestrator";',
    'import { AppPlannerLive } from "@lando/engine/services/planner";',
    'import { makeShellRunnerWithProcessRunnerLive } from "@lando/engine/services/shell-runner";',
    ...
    "    makeShellRunnerWithProcessRunnerLive(makeProcessShellReplIO).pipe(Layer.provide(providerBase)),",
    ...
    "  const subscriberRuntimeLive = makeSubscriberRuntimeWithProcessRunnerLive(bundledPluginModules(), BUILT_IN_COMMAND_IDS).pipe(Layer.provide(runtimeAppBase));",
