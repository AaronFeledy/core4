...
const renderTooling = (): string =>
  [
    ...
    'import { EventService } from "@lando/sdk/services";',
    'import { bundledPluginModules } from "@lando/engine/composition";',
    'import { makeSubscriberRuntimeWithPrivateFileAccessLive } from "@lando/engine/lifecycle/subscribers";',
    'import type { BootstrapLayerInputs } from "@lando/engine/runtime/bootstrap-layer-support";',
    ...
    "  const subscriberRuntimeLive = makeSubscriberRuntimeWithPrivateFileAccessLive(bundledPluginModules(), BUILT_IN_COMMAND_IDS).pipe(Layer.provide(toolingBase));",
...
const renderApp = (): string =>
  [
    ...
    'import { BuildOrchestratorLive } from "@lando/engine/services/build-orchestrator";',
    'import { AppPlannerLive } from "@lando/engine/services/planner";',
    'import { makeShellRunnerWithPrivateFileAccessLive } from "@lando/engine/services/shell-runner";',
    ...
    "    makeShellRunnerWithPrivateFileAccessLive(makeProcessShellReplIO).pipe(Layer.provide(providerBase)),",
    ...
    "  const subscriberRuntimeLive = makeSubscriberRuntimeWithPrivateFileAccessLive(bundledPluginModules(), BUILT_IN_COMMAND_IDS).pipe(Layer.provide(runtimeAppBase));",
