...
import { TELEMETRY_EVENT_NAMES } from "../telemetry/src/inventory.ts";
...
if (import.meta.main) {
  ...
  if (result.ok) {
    ...
    process.stderr.write(
      `Telemetry inventory check failed. Every recorded event must be declared in telemetry/src/inventory.ts and documented in docs/telemetry/events.md in the same change.\n${result.offenders
